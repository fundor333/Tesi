...
Lo scopo di questa tesi è quello di calcolare e visualizzare in modo corretto l'erosione del territorio nell'area geografica scelta.
La tesi \cite{tesi:ambientale} propone quattro soluzioni per la rappresentazione grafica dell'erosione annua del terreno.
...
Questo è stato fatto utilizzando un modello RUSLE basato sull'equazione\footnote{Il modello proposto è quello indicato in \cite[p.~37]{tesi:ambientale}}
